...
void nbody_engine_openmp::copy_buffer(nbody_engine::memory* __a, const nbody_engine::memory* __b, size_t aoff,
									  size_t boff)
{
...
void nbody_engine_openmp::fmadd(memory* __a, const memory* __b, const memory* __c, const nbcoord_t& d, size_t aoff,
